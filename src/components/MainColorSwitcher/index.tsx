    ...
    <>
      ...
      <div className="fixed bottom-0 right-0 z-50 flex items-center justify-center h-12 px-5 mb-10 border rounded-full shadow-md box mr-52">
        ...
        ></a>
          <a
              onClick={() => {
                  switchColorScheme("theme-orange");
              }}
              className={clsx({
                  "block w-8 h-8 cursor-pointer bg-orange-600 rounded-full border-4 hover:border-slate-200":
                      true,
                  "border-slate-300 dark:border-darkmode-800/80":
                      colorScheme == "theme-orange",
                  "border-white dark:border-darkmode-600": colorScheme != "theme-orange",
              })}
          ></a>
      </div>
