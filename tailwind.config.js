  ...
  plugins: [
    ...
    plugin(function ({ addBase, matchUtilities }) {
      addBase({
        ...
        ".theme-orange": {
          "--color-primary": toRGB(colors.orange["600"]),
          "--color-secondary": toRGB(colors.teal["200"]),
          "--color-success": toRGB(colors.lime["600"]),
          "--color-info": toRGB(colors.sky["500"]),
          "--color-warning": toRGB(colors.amber["700"]),
          "--color-pending": toRGB(colors.gray["500"]),
          "--color-danger": toRGB(colors.red["700"]),
          "--color-light": toRGB(colors.white),
          "--color-dark": toRGB(colors.gray["800"]),
          "&.dark": {
